...
Ancak bu ödül rakamı eskisinden farklı. Normalde Ethereum madencilerine şu anki sistem olan PoW sırasında yılda 4.7 milyon adet ETH dağıtılıyor. Yeni sistem olan PoS’de ise bu ödül rakamı 1 milyon ETH’nin altına inebilir. Kesin rakam, ne kadar insanın paralarını, rehin verdiğine bağlı olarak değişecek. Vitalik’in tahmini, yıllık 500 bin ETH civarı bir rakam olacağıydı; ancak şu an için görünen rakamın daha az olacağı.
